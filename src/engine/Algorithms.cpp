...
// public.
    ...
    void CLIBOpenEpiCentre::Algorithms::stat_CLASS_boot0_DECLARE_Algorithm()
    {
    ...
    void CLIBOpenEpiCentre::Algorithms::stat_REG_boot0_DECLARE_Algorithm()
    {
