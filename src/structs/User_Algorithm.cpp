...
// public.
	CLIBOpenEpiCentre::Object* CLIBOpenEpiCentre::User_Algorithm::dyn_CLASS_get_Item_On_List_Of_ptr_PraiseAlgorithmSubsets(uint8_t praiseId)
	{
		...
		{
		case 0:
			return (Object*)stat_CLASS_get_ptr_Algorithm_praise0();
			break;

		case 1:
			return (Object*)stat_CLASS_get_ptr_Algorithm_praise1();
			break;

		case 2:
			return (Object*)stat_CLASS_get_ptr_Algorithm_praise2();
			break;

		case 3:
			return (Object*)stat_CLASS_get_ptr_Algorithm_praise3();
			break;
		}
	}
	...
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot0_DECLAIRE_User_Algorithm()
	{
		std::cout << "entered stat_CLASS_boot0_DECLAIRE_User_Algorithm()" << std::endl;

		std::cout << "exiting stat_CLASS_boot0_DECLAIRE_User_Algorithm()" << std::endl;
	}
	...
	void CLIBOpenEpiCentre::User_Algorithm::stat_REG_boot0_DECLAIRE_User_Algorithm()
	{
		std::cout << "entered stat_REG_boot0_DECLAIRE_User_Algorithm()" << std::endl;

		std::cout << "exiting stat_REG_boot0_DECLAIRE_User_Algorithm()" << std::endl;
	}
// private.
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot1_DEFINE_Algorithm_praise0()
	{
		_stat_CLASS_ptr_Algorithm_praise0 = NULL;
	}
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot1_DEFINE_Algorithm_praise1()
	{
		_stat_CLASS_ptr_Algorithm_praise1 = NULL;
	}
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot1_DEFINE_Algorithm_praise2()
	{
		_stat_CLASS_ptr_Algorithm_praise2 = NULL;
	}
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot1_DEFINE_Algorithm_praise3()
	{
		_stat_CLASS_ptr_Algorithm_praise3 = NULL;
	}
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot3_INITIALISE_Algorithm_praise0()
	{
		...
		while (stat_CLASS_get_ptr_Algorithm_praise0() == NULL) {}
	}
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot3_INITIALISE_Algorithm_praise1()
	{
		...
		while (stat_CLASS_get_ptr_Algorithm_praise1() == NULL) {}
	}
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot3_INITIALISE_Algorithm_praise2()
	{
		...
		while (stat_CLASS_get_ptr_Algorithm_praise2() == NULL) {}
	}
	void CLIBOpenEpiCentre::User_Algorithm::stat_CLASS_boot3_INITIALISE_Algorithm_praise3()
	{
		...
		while (stat_CLASS_get_ptr_Algorithm_praise3() == NULL) {}
	}
