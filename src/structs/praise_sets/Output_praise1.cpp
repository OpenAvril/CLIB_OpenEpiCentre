...
#include <cfloat>
#include <iostream>
double* CLIBOpenEpiCentre::Output_praise1::_REG_ptr_output_praise1_Value = nullptr;
// public.
	...
	void CLIBOpenEpiCentre::Output_praise1::stat_CLASS_boot1_DECLARE_Output_praise1()
	{
		std::cout << "entered stat_CLASS_boot1_DECLARE_Output_praise1()" << std::endl;

		std::cout << "exiting stat_CLASS_boot1_DECLARE_Output_praise1()" << std::endl;
	}
	...
	void CLIBOpenEpiCentre::Output_praise1::stat_REG_boot1_DECLARE_Output_praise1()
	{
		std::cout << "entered stat_REG_boot1_DECLARE_Output_praise1()" << std::endl;

		std::cout << "exiting stat_REG_boot1_DECLARE_Output_praise1()" << std::endl;
	}
// private.
	void CLIBOpenEpiCentre::Output_praise1::stat_REG_boot1_DEFINE_output_Value()
	{
		_REG_ptr_output_praise1_Value = nullptr;
	}
	...
	{
		*_REG_ptr_output_praise1_Value = (double)(1.1);
	}
