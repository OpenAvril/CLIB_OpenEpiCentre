...
#include <cfloat>
#include <iostream>
double* CLIBOpenEpiCentre::Output_praise2::_REG_ptr_output_praise2_Value = nullptr;
// public.
	...
	void CLIBOpenEpiCentre::Output_praise2::stat_CLASS_boot2_DECLARE_Output_praise2()
	{
		...
		std::cout << "exiting stat_CLASS_boot2_DECLARE_Output_praise2()" << std::endl;
	}
	...
	void CLIBOpenEpiCentre::Output_praise2::stat_REG_boot2_DECLARE_Output_praise2()
	{
		...
		std::cout << "exiting stat_REG_boot2_DECLARE_Output_praise2()" << std::endl;
	}
// private.
	void CLIBOpenEpiCentre::Output_praise2::stat_REG_boot1_DEFINE_output_Value()
	{
		_REG_ptr_output_praise2_Value = nullptr;
	}
	...
	{
		*_REG_ptr_output_praise2_Value = (double)(2.2);
	}
