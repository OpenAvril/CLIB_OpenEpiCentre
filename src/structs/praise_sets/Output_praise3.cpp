...
// public.
	...
	double CLIBOpenEpiCentre::Output_praise3::dyn_REG_get_output_Value()
	{
		return *stat_REG_get_ptr_output_Value();
	}
	void CLIBOpenEpiCentre::Output_praise3::dyn_REG_set_output_Value(double newValue)
	{
...
// private.
	void CLIBOpenEpiCentre::Output_praise3::stat_REG_boot1_DEFINE_output_Value()
	{
		_REG_ptr_output_praise3_Value = nullptr;
	}
	void CLIBOpenEpiCentre::Output_praise3::stat_REG_boot2_SUBSTANTIATE_output_Value()
	{
		_REG_ptr_output_praise3_Value = new double();
		*_REG_ptr_output_praise3_Value = (double)(DBL_MAX);
	}
	void CLIBOpenEpiCentre::Output_praise3::stat_REG_boot3_INITIALISE_output_Value()
	{
		*_REG_ptr_output_praise3_Value = (double)(3.3);
	}
	double* CLIBOpenEpiCentre::Output_praise3::stat_REG_get_ptr_output_Value()
	{
		return _REG_ptr_output_praise3_Value;
	}
	void CLIBOpenEpiCentre::Output_praise3::stat_REG_set_Item_output_Value(double newValue)
	{
